...
def _patch_client_builders(
    monkeypatch: pytest.MonkeyPatch,
) -> tuple[_HttpClientFactoryStub, _OpenAiFactoryStub]:
    """Patch transport factories and return the created stubs."""
...
def test_build_client_creates_transport_with_explicit_settings(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    http_client_factory, openai_factory = _patch_client_builders(monkeypatch)
